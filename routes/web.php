...
Route::get('/inventory/{orderBy?}/{sortBy?}', [App\Http\Controllers\HomeController::class, 'showInventory'])->name('home.inventory')->where(['orderBy' => 'quantity|description|reg_price', 'sortBy' => 'asc|desc']);
